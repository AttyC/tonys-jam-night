const FAQS2: React.FC = () => {
    return (
        <ul className="text-md font-medium border-double border-gray-200  dark:bg-gray-700 dark:border-gray-600 dark:text-white py-4 md:p-8 mx-4 md:mx-0">
